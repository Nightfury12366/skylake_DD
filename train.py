...
def get_args():
    ...
    parser.add_argument('-w', '--load_weights', type=str, default=f'weights/efficientdet-d4.pth',
        ...
        for epoch in range(opt.num_epochs):
            ...
            if epoch % opt.val_interval == 0:
                ...
                if loss + opt.es_min_delta < best_loss:
                    best_loss = loss
                    best_epoch = epoch
                    save_checkpoint(model, f'efficientdet-d{opt.compound_coef}_{epoch}_{loss}.pth')  # 保存模型
